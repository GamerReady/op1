...
PS4["13.50"] = {
  ...
  k_prison0: 0x1a5c0c0,
  k_rootvnode: 0x2136e90,
  kpatch: "1350-aiofix.bin", // BUILT (anchored in kernel_1350.elf); kpatch.js 10/10, both neg controls refuse; UNTESTED on hw
  payload: "bin/hen.bin", // PS4-HEN, works through 13.52
};
...
PS4["13.02"] = Object.assign({}, PS4["13.00"], {
  ...
  k_prison0: 0x1a5c0c0,
  k_rootvnode: 0x2136e90,
  kpatch: "1302-aiofix.bin", // ported from 1300.c, 18 sites +0x10; HW-PROVEN on 13.02 (KEXEC rc=0, pass=51)
  payload: "bin/hen.bin", // PS4-HEN, works through 13.52; replaces the non-shipped 13.00 placeholder
  fw_status:
...
PS4["13.04"] = Object.assign({}, PS4["13.00"], {
  ...
  k_prison0: 0x1a5c0c0,
  k_rootvnode: 0x2136e90,
  kpatch: "1302-aiofix.bin", // SAME kernel as 13.02 -> reuses the one blob (HW-PROVEN on 13.02)
  payload: "bin/hen.bin", // PS4-HEN, works through 13.52
  fw_status:
...
export function offsetsFor(uaString) {
  ...
  const base = PS4[key] || null;
  // Clone before applying the page selection so the exported table remains immutable.
  const off = base ? Object.assign({}, base) : null;
  if (off && (window.selectedPayload === "hen" || window.selectedPayload === "goldhen"))
